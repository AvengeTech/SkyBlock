...
use skyblock\games\ui\GamesUi;

use core\utils\TextFormat;
use skyblock\SkyBlockPlayer;

class Controller extends Entity implements ChunkLoader {
	...
	public function __construct(Location $loc, ?CompoundTag $nbt = null, float $scale = 1.0){
		...
		$this->setNametag(TextFormat::AQUA . TextFormat::BOLD . "TECHIT" . PHP_EOL . TextFormat::AQUA . TextFormat::BOLD . "GAMES");
